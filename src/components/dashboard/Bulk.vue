        ...
        <div class="md:col-span-1">
          <div class="px-4 sm:px-0">
            ...
            <p class="mt-1 text-sm text-gray-600">
              ...
              Doloribus eum qui officiis minus molestiae facere ex quia mollitia
              voluptatibus tempore incidunt dolore, voluptates accusantium quas
              quasi, quisquam, doloremque enim dicta!
            </p>
          </div>
        </div>
          ...
          <div class="shadow sm:rounded-md sm:overflow-hidden">
            <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
              <div class="grid grid-cols-3 gap-6">
                <div class="col-span-3 sm:col-span-2">
                  ...
                  <p class="mt-2 text-sm text-gray-500">
                    What is the title of this campaign.
                  </p>
                </div>
              </div>
              ...
              <div>
                ...
                <p class="mt-2 text-sm text-gray-500">
                  Add all your email, separate with commas.
                </p>
                <button
                  type="button"
...
export default {
  ...
  methods: {
    ...
    async gotopreview() {
      ...
      await this.saveselected(this.item);
      // reset item object
      this.item = {
        status: "Active",
        createdAt: new Date()
